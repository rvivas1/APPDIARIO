<template>
    ...
    <div class="overflow-x-auto">
        <div class="min-w-screen  bg-violet-100 flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
            <div class="w-full lg:w-5/6">
                <div class="bg-white shadow-md rounded my-6">
                    <table class="min-w-max w-full table-auto bg-green-100">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                <th class="py-3 px-6 text-center">Tipo y N° Documento</th>
                                <th class="py-3 px-6 text-center">Nombres y apellidos</th>
                                <th class="py-3 px-6 text-center">Celular</th>
                                <th class="py-3 px-6 text-center">Oficina/Local</th>
