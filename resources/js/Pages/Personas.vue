                    ...
                    <table class="border-l-4 border-white mt-2 min-w-max w-full margin-3 table-auto bg-gray-100 border-solid">
                        <thead>
                            <tr class="bg-gray-300 text-red-800 uppercase text-normal text-base leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">Oficina/Local</th>
                                <th class="py-3 px-6 text-center">Estado</th>
                                <th class="py-3 px-6 text-center">Acciones</th>
                            </tr>
                        </thead>
                        <tbody class="text-red-800 text-base font-light">
                            <tr v-for="(objeto,index) in persona" :key="index" class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="font-medium">{{objeto.tipo_documento}} {{objeto.num_doc}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <span>{{objeto.nombre}} {{objeto.apellido}}</span>
                                        <!-- <span>{{objeto.apellido}}</span> -->
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <span>{{objeto.tel}}</span>
                                    </div>
                                </td>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" @click="verPersona">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                            </svg>
                                        </div>
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" @click="actualizarper">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                            </svg>
                                        </div>
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" @click="inactPersona">
...
<div class="max-w-5xl mt-10 mx-auto">
		<div class="grid xl:grid-cols-3 xl:gap-6">
            ...
            <div class="w-full md:mr-2">
               ...
               <select value="tipo" class= "w-full px-3 py-2 text-base leading-tight text-gray-700 border rounded shadow focus:outline-none focus:shadow-outline" name="none">
		...
		<div class="grid xl:grid-cols-3 mb-1 xl:gap-6">
			...
			<div class="mb-4 md:mr-2 md:mb-0">
             ...
             <div class="w-full">
                <select class="w-full px-3 py-2 text-base leading-tight text-gray-700 border rounded shadow focus:outline-none focus:shadow-outline" name="estado">
                   <option value="1">603</option>
                   <option value="0"> 308 - Datacenter</option>
                   <option value="0"> Heinsohn business technology</option>
               </select>
            </div>
          </div>
		</div>
